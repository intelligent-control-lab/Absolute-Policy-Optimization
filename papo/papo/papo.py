...
if __name__ == '__main__':
    ...
    parser.add_argument('--k', '-k', type=float, default=17.0)
    ...
    if args.atari_name == None:
        ...
        exp_name = args.task + '_' + args.exp_name + '_' + detail + '_'\
              + f"{args.omega1}_{args.omega2}" + '_' \
              + 'kl' + str(args.target_kl) + '_' + 'epochs' + str(args.epochs)
    else:
        import gymnasium
        detail = 'Detailed' if args.detailed else 'notDetailed'
