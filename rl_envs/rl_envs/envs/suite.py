...
class SafexpEnvBase:
    ...
    def register(self, name='', config={}):
        # Note: see  rl_envs/envs/mujoco.py for an explanation why we're using
        # ' rl_envs.envs.mujoco:Engine' as the entrypoint, instead of
        # ' rl_envs.envs.engine:Engine'.
        for robot_name, robot_config in self.robot_configs.items():
            ...
            register(id=env_name,
                     entry_point=' rl_envs.envs.mujoco:Engine',
