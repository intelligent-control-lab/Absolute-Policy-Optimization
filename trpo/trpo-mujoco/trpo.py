...
def trpo(env_fn, actor_critic=core.MLPActorCritic, ac_kwargs=dict(), seed=0, 
        ...
        target_kl=0.01, logger_kwargs=dict(), save_freq=10, backtrack_coeff=0.8, backtrack_iters=100, model_save=False, mujoco=None):
    """
...
if __name__ == '__main__':
    ...
    trpo(lambda : create_env(args), actor_critic=core.MLPActorCritic,
        ...
        logger_kwargs=logger_kwargs, model_save=model_save, target_kl=args.target_kl, max_ep_len=args.max_ep_len, mujoco=args.mujoco_name)
