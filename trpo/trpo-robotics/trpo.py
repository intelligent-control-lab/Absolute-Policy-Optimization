...
def trpo(env_fn, actor_critic=core.MLPActorCritic, ac_kwargs=dict(), seed=0, 
        ...
        target_kl=0.01, logger_kwargs=dict(), save_freq=10, backtrack_coeff=0.8, backtrack_iters=100, model_save=False, robotics=None):
    """
...
if __name__ == '__main__':
    ...
    if args.robotics_name == None:
        exp_name = args.task + '_' + args.exp_name + '_' + 'kl' + str(args.target_kl)\
              + '_' + 'epochs' + str(args.epochs)
    else:
        import gymnasium
        exp_name = args.robotics_name + '_' + args.exp_name + '_' + 'kl' + str(args.target_kl) + '_' + 'epochs' + str(args.epochs)
    ...
    trpo(lambda : create_env(args), actor_critic=core.MLPActorCritic,
        ...
        logger_kwargs=logger_kwargs, model_save=model_save, target_kl=args.target_kl, max_ep_len=args.max_ep_len, robotics=args.robotics_name)
