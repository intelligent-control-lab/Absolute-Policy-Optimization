...
def apo(env_fn, omega_1, omega_2, k=10., actor_critic=core.MLPActorCritic, ac_kwargs=dict(), seed=0, 
...
if __name__ == '__main__':
    ...
    parser.add_argument('--mujoco_name', '-m', type=str, choices=['Humanoid', 'HumanoidStandup'])   
    ...
    apo(lambda : create_env(args), actor_critic=core.MLPActorCritic,
        ...
        k=args.k, omega_1=args.omega1, omega_2=args.omega2, mujoco=args.mujoco_name, detailed=args.detailed)
