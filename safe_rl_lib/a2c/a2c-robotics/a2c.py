...
def a2c(env_fn, actor_critic=core.MLPActorCritic, ac_kwargs=dict(),  seed=0, 
        ...
        logger_kwargs=dict(), save_freq=10, robotics=None):
    """
...
if __name__ == '__main__':
    ...
    if args.robotics_name == None:
        ...
        import gymnasium
        exp_name = args.robotics_name + '_' + args.exp_name + '_' + 'epochs' + str(args.epochs)
    logger_kwargs = setup_logger_kwargs(exp_name, args.seed)

    a2c(lambda : create_env(args), actor_critic=core.MLPActorCritic,
        ac_kwargs=dict(hidden_sizes=[args.hid]*args.l), gamma=args.gamma, 
        seed=args.seed, steps_per_epoch=args.steps, epochs=args.epochs,
        logger_kwargs=logger_kwargs, robotics=args.robotics_name)